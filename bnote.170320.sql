...
--
-- Host: localhost    Database: mdnote
-- ------------------------------------------------------
...
INSERT INTO `notebooks` VALUES (1,'默认笔记',1,1,0,NULL,NULL),(2,'我的草稿',1,1,0,'2016-07-28 22:19:02','2016-07-28 22:19:02');
...
CREATE TABLE `notes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_user_folder` (`user_id`,`notebook_id`)
...
INSERT INTO `users` VALUES (1,'kaychen@qq.com','kaychen@qq.com','4297f44b13955235245b2497399d7a93',NULL,NULL,NULL);
...
-- Dump completed on 2017-03-20 23:17:35
