...
<div id="web" class="text-center">
	...
	<div class="login form-horizontal">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-9">
	      <input type="password" class="form-control" v-model="password2" placeholder="重复密码">
	    </div>
	  </div>
	  <a type="button" class="btn btn-default" v-on:click="register()">注册</a>
	  <a type="button" href="/user/login" class="btn btn-default">登录</a>
	</div>
</div>
...
<script src="/public/js/vregister.js"></script>
</body>
</html>